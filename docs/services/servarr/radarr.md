...
Select the root path you added earlier [in the root folders section.](https://wiki.servarr.com/en/radarr/quick-start-guide#root-folders)
...
1. If you want all your movie folders renamed to your folder naming scheme you set earlier [movie naming section](https://wiki.servarr.com/en/radarr/quick-start-guide#movie-naming).
...
1. Root Folder - Radarr will add the movie to the Root Folder you’ve setup [in the root folders section](https://wiki.servarr.com/en/radarr/quick-start-guide#root-folders)
...
3. Availability - When Radarr shall consider a movie is available.
    ...
    > For More Information on TMDB's Dates that impact the below Availabilities See [How Does Radarr Determine the Year of the Movie](https://wiki.servarr.com/en/radarr/quick-start-guide#how-does-radarr-determine-the-year-of-a-movie)
