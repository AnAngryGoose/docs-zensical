...
> For a more detailed breakdown of all the settings, check [Sonarr =>Settings](https://wiki.servarr.com/sonarr/settings)
...
Most torrent trackers require [Prowlarr](https://wiki.servarr.com/prowlarr) or Jackett to be used in Sonarr
...
> See the [settings page](https://wiki.servarr.com/sonarr/settings#download-clients), at the [More Info (Supported)](https://wiki.servarr.com/sonarr/supported#download-clients) page for this section, and [TRaSH's Download Client Guides](https://trash-guides.info/Downloaders/) for more information.
